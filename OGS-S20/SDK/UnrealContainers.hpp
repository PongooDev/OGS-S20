...
{	
	...
	static void* (*Realloc)(void* Ptr, SIZE_T Count, uint32 Alignment) = decltype(Realloc)(__int64(GetModuleHandleW(0)) + 0x1d6e680);

	static void* (*FreeMem)(void* a1) = decltype(FreeMem)(__int64(GetModuleHandleW(0)) + 0xd46450);
